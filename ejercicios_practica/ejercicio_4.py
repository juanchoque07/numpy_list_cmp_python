...
if __name__ == '__main__':
    ...
    conversor_string_int = [int(x) if x.isdigit() else 0 for x in list_numeros_str]
    print(conversor_string_int)
    ...
    """ Si, la lista quedo asi [5, 2, 0, 0, 7, 0] y .isdigit() leyo que no era un caracter numeral al hacer '-3' """
